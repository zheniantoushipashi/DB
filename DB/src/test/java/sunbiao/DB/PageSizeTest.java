...
public class PageSizeTest extends TestCase {
			...
			int AvailableSize = recordManager.getpageSize().getAvailableSizeByPageNum(CurrentPageNum);
		    ...
		    AvailableSize = recordManager.getpageSize().getAvailableSizeByPageNum(CurrentPageNum);
